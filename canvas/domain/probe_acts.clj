(ns canvas.domain.probe-acts
  ...
  (:require [canvas.domain.probe :refer [Probe Finding]]
...
;; invariant in prose; the executable check lives in canvas.materialize.realization.
