(ns canvas.domain.lens-model
  "Self-spec: fukan's LENSES — the focuses over the model. A lens names WHAT to attend to
   ...
   lives in the realization view (`canvas.materialize.realization`, a `LensSelection`,
